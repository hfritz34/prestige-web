    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="flex flex-col items-center p-4">
        <Avatar className="w-24 h-24">
          <AvatarImage
            src={userQuery.data?.profilePicURL || "https://github.com/shadcn.png"}
          />
          <AvatarFallback>{userQuery.data?.nickName}</AvatarFallback>
        </Avatar>
        <h2 className="text-xl font-bold mt-6">
          {userQuery.data?.nickName || "User"}
        </h2>
      </div>
      ...
      <div id="Favorite Tracks/Artists/Albums" className="px-4">
        ...
        <FavoritesCarousel type={viewTypeFavorite}/>
      </div>
      <div className="mt-5">
        <RecentlyPlayed />
        <NavBar />
